...
export default function Display() {
	...
	if (displayState === 'default') {
		...
		return (
			<div className='flex flex-col place-content-start place-items-center gap-[1.8vw]'>
				<h2 className='inline-flex flex-col place-items-center font-bebas-neue text-[3.35vw] text-foreground text-center tracking-[-3%] leading-[100%] -translate-y-[50%] after:w-full after:h-[0.15vw] after:bg-accent after:-translate-y-[0.25vw] after:shadow-[0_0_1vw_0.05vw_var(--accent)]'>
					Team Analysis
				</h2>
				<span>
					...
					<TypeLogos className='w-[3vw]' options={{ normal: 1 }} />
				</span>
				{/* <span>
					<h3 className='font-bebas-neue text-[1.7vw] text-foreground text-center tracking-[-3%] leading-[100%]'>
						Weaknesses
					</h3>
				</span> */}
			</div>
